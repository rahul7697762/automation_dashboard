            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
                ...
                <div className="col-span-1 md:col-span-2">
                    <div className="flex items-center gap-2 mb-6">
                        <img src={Logo} alt="Bitlance" className="h-10 w-auto" />

                    </div>
                    <p className="text-gray-400 mb-8 max-w-sm leading-relaxed">
                        The AI agent that works 24/7 to capture leads, answer questions, and book appointments, so you can focus on closing deals.
                    </p>
                    {/* <div className="flex gap-4">
                        <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-all">
                            <Twitter size={18} />
                        </a>
                        <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-all">
                            <Linkedin size={18} />
                ...
                <div>
                    ...
                    <ul className="space-y-6">
                        <li className="flex items-start gap-3 group">
                            <div className="mt-1 w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center shrink-0 group-hover:bg-indigo-600/20 group-hover:text-indigo-400 transition-colors">
                                <MapPin size={18} />
                            </div>
                        ...
                        <li className="flex items-center gap-3 group">
                            <div className="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center shrink-0 group-hover:bg-indigo-600/20 group-hover:text-indigo-400 transition-colors">
                                <Mail size={18} />
                            </div>
