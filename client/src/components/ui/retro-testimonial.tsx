        ...
        <>
                    ...
                    <div className="fixed inset-0 h-screen overflow-hidden z-50">
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="px-0 md:px-20 text-neutral-800/80 text-lg font-thin font-serif underline underline-offset-8"
                            >
                                {testimonial.designation}
                            </motion.p>
                            <motion.p
                                layoutId={layout ? `title-${testimonial.name}` : undefined}
                                className="px-0 md:px-20 text-2xl md:text-4xl font-normal italic text-neutral-800/80 mt-4 font-serif lowercase"
                            >
                                {testimonial.name}
                            </motion.p>
                            <div className="py-8 text-neutral-800/80 px-0 md:px-20 text-3xl lowercase font-thin font-serif leading-snug tracking-wide">
                                <Quote className="h-6 w-6 text-neutral-800/80 dark:text-neutral-900" />
            ...
            >
                ...
                >
                    ...
                    <motion.p
                        layoutId={layout ? `title-${testimonial.name}` : undefined}
                        className="text-neutral-800/80 text-2xl md:text-2xl font-normal text-center [text-wrap:balance] font-serif mt-4 lowercase px-3"
                    >
                    ...
                    <motion.p
                        layoutId={layout ? `category-${testimonial.name}` : undefined}
                        className="text-neutral-800/80 text-xl md:text-2xl font-thin font-serif italic text-center mt-5 lowercase"
                    >
                        {testimonial.name}.
                    </motion.p>
                    <motion.p
                        layoutId={layout ? `category-${testimonial.name}` : undefined}
                        className="text-neutral-800/80 text-base md:text-base font-thin font-serif italic text-center mt-1 lowercase underline underline-offset-8 decoration-1"
                    >
