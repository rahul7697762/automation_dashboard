    ...
    return (
        ...
        >
            ...
            <div className="p-6 flex-1 flex flex-col">
                {/* Meta */}
                <div className="flex items-center text-[11px] text-gray-500 mb-4 gap-4 tracking-widest uppercase" style={{ fontFamily: "'DM Mono', monospace" }}>
                ...
                <Link to={article.slug ? `/blogs/${article.slug}` : `/blogs/${article.id}`} className="block mb-4">
                    <h3 className="text-xl font-bold text-black line-clamp-2 transition-colors group-hover:text-[#26CECE] tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                        {article.seo_title || article.topic}
                    </h3>
                </Link>

                {/* Excerpt */}
                <p className="text-gray-600 text-sm mb-6 line-clamp-3 flex-1 leading-relaxed" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                    {article.content
                ...
                <div className="mt-auto pt-4 border-t border-gray-200 flex items-center justify-between">
                    <span 
                        className="text-[10px] uppercase font-bold px-2 py-1 text-gray-500 tracking-widest"
                        style={{ fontFamily: "'DM Mono', monospace", background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 2 }}
                    >
