...
export default function SeoLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-dark text-white overflow-x-hidden" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <a
        href="https://wa.me/917697762374?text=Hi%20Bitlance!%20I%27d%20like%20to%20know%20more%20about%20the%20SEO%20AI%20Agent."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat on WhatsApp"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-xl shadow-black/40 hover:scale-110 transition-transform"
